...
export const SectionLogos = ({ section }: { section: 'hero' | 'services' | 'testimonials' }) => {
  const MetaIcon = () => (
    <div className="absolute opacity-10 animate-pulse">
  ...
  if (section === 'hero') {
    return (
      <>
        ...
        <div className="absolute bottom-32 left-16 animate-pulse" style={{ animationDelay: '4s' }}>
          <MetaIcon />
        </div>
      </>
    );
  ...
  if (section === 'testimonials') {
    return (
      <>
        <div className="absolute top-5 right-5 animate-pulse" style={{ animationDelay: '2s' }}>
          <GoogleIcon />
        </div>
        <div className="absolute bottom-5 left-5 animate-bounce" style={{ animationDelay: '4s' }}>
          <MetaIcon />
        </div>
      </>
    );
